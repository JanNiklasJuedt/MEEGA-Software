...
#if QT_CONFIG(tooltip)
        self.statusLabelMainboardT.setToolTip("")
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.statusLabelCover.setToolTip("")
#endif // QT_CONFIG(tooltip)
