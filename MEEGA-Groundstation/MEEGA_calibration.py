...
class Ui_Sensor_Calibration(object):
    ...
    def retranslateUi(self, Sensor_Calibration):
        ...
        self.comboBox.setItemText(3, QCoreApplication.translate("Sensor_Calibration", u"T Accumulator", None))
        self.comboBox.setItemText(4, QCoreApplication.translate("Sensor_Calibration", u"P Chamber", None))
        self.comboBox.setItemText(5, QCoreApplication.translate("Sensor_Calibration", u"T Chamber 2", None))
        self.comboBox.setItemText(6, QCoreApplication.translate("Sensor_Calibration", u"T Chamber 2", None))
        self.comboBox.setItemText(7, QCoreApplication.translate("Sensor_Calibration", u"P Nozzle 1", None))
        self.comboBox.setItemText(8, QCoreApplication.translate("Sensor_Calibration", u"T Nozzle 1", None))
        self.comboBox.setItemText(9, QCoreApplication.translate("Sensor_Calibration", u"P Nozzle 2", None))
        self.comboBox.setItemText(10, QCoreApplication.translate("Sensor_Calibration", u"T Nozzle 2", None))
        self.comboBox.setItemText(11, QCoreApplication.translate("Sensor_Calibration", u"P Nozzle 3", None))
        self.comboBox.setItemText(12, QCoreApplication.translate("Sensor_Calibration", u"T Nozzle 3", None))
