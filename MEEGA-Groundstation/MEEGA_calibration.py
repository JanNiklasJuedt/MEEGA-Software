...
class Ui_Calibration(object):
    def setupUi(self, Calibration):
        ...
        Calibration.resize(400, 250)
        Calibration.setMinimumSize(QSize(400, 250))
        Calibration.setMaximumSize(QSize(400, 250))
        ...
        self.okButton.setGeometry(QRect(10, 200, 381, 29))
        ...
        self.layoutWidget.setGeometry(QRect(10, 110, 381, 81))
