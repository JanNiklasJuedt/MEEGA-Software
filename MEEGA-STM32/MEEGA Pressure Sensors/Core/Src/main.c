...
int main(void)
{
  ...
  //const uint32_t RefreshData_Timeout = 50; //refresh every 20 ms -CHANGEABLE-
  /* USER CODE END 2 */
  ...
  while (1)
  {
	  //unsigned char rxMSG = 0, txMSG = CMD_SYNC;
	  ...
	  //int i = 0; i < TxPACKET_LENGTH; i++) if (rxCMD[i] == CMD_RESYNC) break;
	  //}
    /* USER CODE END WHILE */
